...
</tr></table><table class="es-content" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%"><tr style="border-collapse:collapse"><td align="center" style="padding:0;Margin:0"><table class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"><tr style="border-collapse:collapse"><td align="left" style="padding:0;Margin:0"><table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr style="border-collapse:collapse"><td valign="top" align="center" style="padding:0;Margin:0;width:600px"><table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation"><tr style="border-collapse:collapse"><td class="es-m-txt-l" bgcolor="#ffffff" align="center" style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:30px;padding-right:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">Hai ricevuto una risposta al tuo commento sul post ${post.postTitle}</p>
</td></tr></table></td></tr></table></td>
</tr><tr style="border-collapse:collapse"><td align="left" style="padding:0;Margin:0;padding-bottom:20px;padding-left:30px;padding-right:30px"><table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr style="border-collapse:collapse"><td valign="top" align="center" style="padding:0;Margin:0;width:540px"><table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr style="border-collapse:collapse"><td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:40px;padding-bottom:40px"><span class="es-button-border" style="border-style:solid;border-color:#7C72DC;background:#01A2F9;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a href="https://artedellalettura.it/${post.postSlug}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#01A2F9;border-width:15px 25px 15px 25px;display:inline-block;background:#01A2F9;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">Vedi Commento</a></span></td>
</tr></table></td></tr></table></td></tr></table></td>
...
function getEmails(comments: Array<Comment>, newComment: Comment): Set<string> {
  ...
  let parent = getParent(comments, newComment);

  while (parent) {
    emails.push(decrypt(parent.email as Hash));
    parent = getParent(comments, parent);
  }
...
function sendEmail(
  ...
  return new Promise((resolve, reject) => {
    const mailOptions = {
      from: "Arte della Lettura <artedellalettura@gmail.com>",
      to: emailTo,
      bcc: "artedellalettura@gmail.com",
      subject: `Nuovo commento sul post ${emailData.postTitle}`,
      text: `Hai ricevuto una risposta al tuo commento sul post ${emailData.postTitle}}. 
    Link al post: http://localhost:3000/${emailData.postSlug}`,
      html: getHTML(emailData),
    };
...
function sendEmailToAdmin(
  ...
  return new Promise((resolve, reject) => {
    const mailOptions = {
      from: "Arte della Lettura <artedellalettura@gmail.com>",
      to: "artedellalettura@gmail.com",
      subject: `Nuovo commento sul post ${emailData.postTitle}`,
      text: `Nuovo commento sul post ${emailData.postTitle}}.
    Link al post: http://localhost:3000/${emailData.postSlug}`,
      html: getHTML(emailData),
    };
