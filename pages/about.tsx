export default function About(): JSX.Element {
  return (
    <div className="mx-auto">
      ...
      <p>
        Ciao, sono Alessio e su questo blog parlo di libri e fumetti. I miei generi preferiti sono distopico, fantasy e
        narrativa di viaggio. Adoro i libri, i videogiochi, programmare, scrivere e spesso mi diverto a criticare cose,
        come si può notare da questo blog. Se volete sapere altro non esitate a contattarmi via{" "}
